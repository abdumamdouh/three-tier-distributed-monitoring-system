...
class ComputerServerHandler implements Runnable {
    ...
    public  ComputerServerHandler(Socket socket) {
        this.socket = socket;
    }
...
public class MultithreadedComputerServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            while(true){
                ...
                ComputerServerHandler CSH = new ComputerServerHandler(socketDriverComputer);
